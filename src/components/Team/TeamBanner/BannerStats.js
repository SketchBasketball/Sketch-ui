  ...
  return (
    <div className="banner-stats-wrapper">
      <div className="banner-stats-title">
        <div className="banner-division">{teamStats[0]?.league_fullname}</div>
      ...
      <div className="banner-stats-container">
        <div className="banner-score">
          <div>
            <div className="banner-score-stat">{teamWLStats[0]?.games}</div>
          ...
          <div>
            <div className="banner-score-stat">{teamWLStats[1]?.games}</div>
